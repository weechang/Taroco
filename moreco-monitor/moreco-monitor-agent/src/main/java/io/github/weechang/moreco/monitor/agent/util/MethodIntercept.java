...
//        if (method != null) {
//            MethodInfo mi = io.github.weechang.moreco.monitor.agent.Monitor.methodStart(method.key());
//
//            Object var5;
//            try {
...
//                if (method.success()) {
//                    io.github.weechang.moreco.monitor.agent.Monitor.methodFail(mi);
//                }
//
//                throw var9;
//            } finally {
//                io.github.weechang.moreco.monitor.agent.Monitor.methodFinish(mi);
//            }
//
//            return var5;
//        } else {
