...
export const appRouter = [
    ...
    },
    {
        ...
        component: Main,
        children: [
            { path: 'index', title: '原始股东设置', name: 'holdersetting', component: resolve => { require(['@/views/sys/holdersetting.vue'], resolve); } },
            { path: 'group', title: '团队奖励设置', name: 'group', component: resolve => { require(['@/views/sys/groupsetting.vue'], resolve); } },
            { path: 'partner', title: '代理商等级设置', name: 'partner', component: resolve => { require(['@/views/sys/agentsetting.vue'], resolve); } }
        ]
    },
    {
        path: '/product',
        ...
        component: Main,
        children: [
            { path: 'index', title: '产品管理', name: 'productindex', component: resolve => { require(['@/views/holder/allholder.vue'], resolve); } },
            { path: 'level', title: '产品&等级关系', name: 'productlevel', component: resolve => { require(['@/views/holder/allholder.vue'], resolve); } },
            { path: 'records', title: '拿货记录', name: 'productrecords', component: resolve => { require(['@/views/holder/allholder.vue'], resolve); } }
        ]
    },
    {
        path: '/user',
        ...
        component: Main,
        children: [
            { path: 'index', title: '原始股东/合伙人', name: 'allholder', component: resolve => { require(['@/views/holder/allholder.vue'], resolve); } },
            { path: 'agent', title: '代理商', name: 'agent', component: resolve => { require(['@/views/holder/allholder.vue'], resolve); } },
            { path: 'inviter', title: '邀请记录', name: 'inviter', component: resolve => { require(['@/views/holder/allholder.vue'], resolve); } }
        ]
    },
    {
        path: '/awards',
        ...
        component: Main,
        children: [
            { path: 'index', title: '邀请奖励', name: 'inviteraward', component: resolve => { require(['@/views/holder/allholder.vue'], resolve); } },
            { path: 'commission', title: '提成奖励', name: 'commission', component: resolve => { require(['@/views/holder/allholder.vue'], resolve); } }
        ]
    }
];
