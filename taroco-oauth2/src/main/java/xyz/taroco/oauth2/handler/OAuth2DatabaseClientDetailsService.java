...
import xyz.taroco.oauth2.dao.GrantTypeDao;
import xyz.taroco.oauth2.dao.ResourceIdDao;
import xyz.taroco.oauth2.dao.ScopeDao;
import xyz.taroco.oauth2.domain.*;
...
public class OAuth2DatabaseClientDetailsService implements ClientDetailsService, ClientRegistrationService {
    ...
    @Autowired
    private GrantTypeDao grantTypeRepository;

    @Autowired
    private ScopeDao scopeRepository;

    @Autowired
    private ResourceIdDao resourceIdRepository;
