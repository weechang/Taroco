 ...
 *
 * @author zhangwei
 * @version 2018/2/22 10:02.
 */
@Data
@EqualsAndHashCode(callSuper = false)
@NoArgsConstructor
public class MenuDeleteCommand extends AuditAbleAbstractCommand {
    ...
    public MenuDeleteCommand(AuditEntry auditEntry, String id, Boolean logic){
        super(auditEntry);
        this.id = id;
