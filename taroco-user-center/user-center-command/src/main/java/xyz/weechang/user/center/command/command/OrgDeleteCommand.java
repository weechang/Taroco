 ...
 *
 * @author zhangwei
 * @version 2018/2/22 10:08.
 */
@Data
@EqualsAndHashCode(callSuper = false)
@NoArgsConstructor
public class OrgDeleteCommand extends AuditAbleAbstractCommand {
    ...
    public OrgDeleteCommand(AuditEntry auditEntry, String id, Boolean logic){
        super(auditEntry);
        this.id = id;
